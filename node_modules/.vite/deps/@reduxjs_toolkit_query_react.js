...
function findNonSerializableValue(value, path = "", isSerializable = isPlain, getEntries, ignoredPaths = [], cache3) {
  ...
  if (cache3 == null ? void 0 : cache3.has(value)) return false;
...
var isDOM = canUseDOM2();
var isRunningInReactNative = () => typeof navigator !== "undefined" && navigator.product === "ReactNative";
var isReactNative2 = isRunningInReactNative();
...
function ApiProvider(props) {
  ...
  const [store] = React3.useState(() => configureStore({
    reducer: {
  ...
  return React3.createElement(Provider_default, { store, context }, props.children);
}
